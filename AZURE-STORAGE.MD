...
- **Blob de Bloco**: 
  - Armazena dados de arquivos grandes (até 4,75 TB).
  - Permite uploads em partes.

- **Blob de Página**: 
  - Ideal para discos de máquinas virtuais.

- **Blob de Anexo**: 
  - Armazena grandes arquivos de dados acessíveis via URLs.
